...
| 1.3.x | Network analysis: subnet calc, connection table, port scanner, LAN discovery, DNS inspector, speedtest history, latency monitor, bandwidth monitor shipped — packet capture next | In progress |
