module blackout-warp

go 1.26.0

require github.com/bepass-org/warp-plus v1.2.6
...
replace github.com/pion/dtls/v2 => ./compat/pion-dtls-v2

replace github.com/pion/stun => ./compat/pion-stun
